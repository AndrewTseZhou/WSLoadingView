...
public class WSMaterialLoading extends View {
    ...
    private static final float MIN_SWEEP_DEGREE = 0.1f;
    private static final float MAX_SWEEP_DEGREES = 0.8f * DEGREE_360;
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        if (mValueAnimator <= START_TRIM_DURATION_OFFSET) {
                            ...
                            mStartAngle = startTrimProgress * MAX_ROTATION_INCREMENT;

                            mSweepAngle = startTrimProgress * MAX_SWEEP_DEGREES;
                        }

                        if (mValueAnimator > START_TRIM_DURATION_OFFSET) {
                            float endTrimProgress = (mValueAnimator - START_TRIM_DURATION_OFFSET) / (END_TRIM_DURATION_OFFSET - START_TRIM_DURATION_OFFSET);

                            mSweepAngle = MAX_SWEEP_DEGREES - endTrimProgress * MAX_SWEEP_DEGREES;

                            Log.e("-------------", "***********" + endTrimProgress);

                            mStartAngle = MAX_ROTATION_INCREMENT + endTrimProgress * MAX_SWEEP_DEGREES;
